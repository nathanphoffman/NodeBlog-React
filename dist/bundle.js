...
/***/ function(module, exports, __webpack_require__) {
	...
	var Page = __webpack_require__(169);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TagBar = __webpack_require__(174);

	var Preview = __webpack_require__(175);
	var Post = __webpack_require__(180);
	...
	module.exports = (function(){var ____Class1=React.Component;for(var ____Class1____Key in ____Class1){if(____Class1.hasOwnProperty(____Class1____Key)){____Class0[____Class1____Key]=____Class1[____Class1____Key];}}var ____SuperProtoOf____Class1=____Class1===null?null:____Class1.prototype;____Class0.prototype=Object.create(____SuperProtoOf____Class1);____Class0.prototype.constructor=____Class0;____Class0.__superConstructor__=____Class1;function ____Class0(){"use strict";if(____Class1!==null){____Class1.apply(this,arguments);}}
	  Object.defineProperty(____Class0.prototype,"render",{writable:true,configurable:true,value:function() {"use strict";
	    ...
	    if (this.state && this.state.route) {
	      ...
	      else if (this.state.route == 'post') route = (React.createElement(Post, {id: this.state.id})) 
	      else if (this.state.route == 'error') route = (React.createElement("div", null, this.state.error.message))
	    }
	    else route = null; // we do nothing if the route is still rendering

	    return (React.createElement("div", null, React.createElement(Navbar, null), React.createElement(Header, null), React.createElement(TagBar, null), 
	      React.createElement("div", {className: "container"}, 
	        React.createElement("div", {className: "row"}, 
	          React.createElement("div", {className: "col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0"}, 
	            route
	          )
	        )
	      ), 
	      React.createElement("hr", null), React.createElement(Footer, null)));
	  }});
	return ____Class0;})()
	    ...
	    React.createElement("nav", {className: "navbar navbar-default navbar-custom navbar-fixed-top"}, 
	        React.createElement("div", {className: "container-fluid"}, 
	            React.createElement("div", {className: "navbar-header page-scroll"}, 
	                ...
	                React.createElement("a", {className: "navbar-brand", href: "index.html"}, "The Coding Astronomer")
	            ), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (function(){var ____Class7=React.Component;for(var ____Class7____Key in ____Class7){if(____Class7.hasOwnProperty(____Class7____Key)){____Class6[____Class7____Key]=____Class7[____Class7____Key];}}var ____SuperProtoOf____Class7=____Class7===null?null:____Class7.prototype;____Class6.prototype=Object.create(____SuperProtoOf____Class7);____Class6.prototype.constructor=____Class6;____Class6.__superConstructor__=____Class7;function ____Class6(){"use strict";if(____Class7!==null){____Class7.apply(this,arguments);}}
	  Object.defineProperty(____Class6.prototype,"render",{writable:true,configurable:true,value:function() {"use strict";
	      ...
	      return (
	    React.createElement("header", {className: "intro-header", style: bg}, 
	        React.createElement("div", {className: "container"}, 
	            React.createElement("div", {className: "row"}, 
	                React.createElement("div", {className: "col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0"}, 
	                    React.createElement("div", {className: "site-heading"}, 
	                        React.createElement("h1", {className: "hidden-xs"}, "The Coding Astronomer"), 
	                        React.createElement("h2", {className: "visible-xs"}, "The Coding Astronomer"), 
	                        React.createElement("hr", {className: "small"}), 
	                        React.createElement("span", {className: "subheading"}, "The Blog of Nathan P Hoffman",  
	                        React.createElement("br", null), React.createElement("span", {className: "hidden-xs"}, "Programmer, Amateur Astronomer, & Dabbler in Art.")
	                        )
	                    )
	                )
	            )
...
/***/ function(module, exports, __webpack_require__) {
	...
	/** @jsx React.DOM */var React = __webpack_require__(2);
	var LgIcon = __webpack_require__(173);
	                    ...
	                    React.createElement("div", {className: "row"}, 
	                        React.createElement("div", {className: "col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0"}, 
	                            React.createElement("ul", {className: "list-inline text-center"}, 
	                                React.createElement(LgIcon, {address: "#", icon: "twitter"}), 
	                                React.createElement(LgIcon, {address: "#", icon: "github"}), 
	                                React.createElement(LgIcon, {address: "#", icon: "stack-overflow"}), 
	                                React.createElement("br", null)
	                            ), 
	                            React.createElement("p", {className: "copyright text-muted"}, 
	                                "All original content by Nathan P Hoffman,", " ", 
	                                React.createElement("a", {target: "_blank", href: "https://creativecommons.org/licenses/by-sa/2.0/"}, "CC-BY-SA 2.0"), 
	                                React.createElement("br", null), "This blog was adapted by me with ReactJS and NodeJS you can find the source at those links.", " ", 
	                                React.createElement("a", {target: "_blank", href: "http://startbootstrap.com/template-overviews/clean-blog/"}, "Clean Blog"), 
	                                React.createElement("br", null), "The original css/site styles here: ", " ", 
	                                React.createElement("a", {target: "_blank", href: "http://startbootstrap.com/template-overviews/clean-blog/"}, "Clean Blog")
	                            )
	                        )
	                    )
	    ...
	    if(this.props.selected) return (
	        React.createElement("a", {href: this.props.address}, 
	            React.createElement("span", {className: "fa-stack fa-lg"}, 
	                ...
	                React.createElement("i", {className: "fa fa-" + this.props.icon + " fa-stack-1x fa-inverse"})
	            )
	        ));
	    else return (
	        React.createElement("a", {href: this.props.address}, 
	            React.createElement("span", {className: "fa-stack fa-lg"}, 
	                React.createElement("i", {className: "fa fa-circle fa-stack-2x fa-inverse"}), 
	                React.createElement("i", {className: "fa fa-" + this.props.icon + " fa-stack-1x"})
	            )
	        ));
	  }});
	return ____Classg;})()
	...
	module.exports = (function(){var ____Class9=React.Component;for(var ____Class9____Key in ____Class9){if(____Class9.hasOwnProperty(____Class9____Key)){____Class8[____Class9____Key]=____Class9[____Class9____Key];}}var ____SuperProtoOf____Class9=____Class9===null?null:____Class9.prototype;____Class8.prototype=Object.create(____SuperProtoOf____Class9);____Class8.prototype.constructor=____Class8;____Class8.__superConstructor__=____Class9;function ____Class8(){"use strict";if(____Class9!==null){____Class9.apply(this,arguments);}}
	    Object.defineProperty(____Class8.prototype,"render",{writable:true,configurable:true,value:function() {"use strict";
	        ...
	        return (
	            React.createElement("div", {className: "container"}, 
	                React.createElement("div", {className: "row"}, 
	                    React.createElement("div", {className: "col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0 text-center"}, 
	                        React.createElement(LgIcon, {address: "#tag/web-frontend", icon: "chrome"}), 
	                        React.createElement(LgIcon, {address: "#tag/web-server", icon: "server"}), 
	                        React.createElement(LgIcon, {address: "#tag/space", icon: "space-shuttle"}), 
	                        React.createElement(LgIcon, {address: "#tag/photos", icon: "camera"}), 
	                        React.createElement(LgIcon, {address: "#tag/painting", icon: "paint-brush"}), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var SmIcon = __webpack_require__(176);
	var PreviewItem = __webpack_require__(177);
	var data = __webpack_require__(178);

	module.exports = (function(){var ____Classb=React.Component;for(var ____Classb____Key in ____Classb){if(____Classb.hasOwnProperty(____Classb____Key)){____Classa[____Classb____Key]=____Classb[____Classb____Key];}}var ____SuperProtoOf____Classb=____Classb===null?null:____Classb.prototype;____Classa.prototype=Object.create(____SuperProtoOf____Classb);____Classa.prototype.constructor=____Classa;____Classa.__superConstructor__=____Classb;function ____Classa(){"use strict";if(____Classb!==null){____Classb.apply(this,arguments);}}

	    Object.defineProperty(____Classa.prototype,"componentDidMount",{writable:true,configurable:true,value:function() {"use strict";
	        data.getPreviews(function (previews) {
	            this.setState({ posts: previews });
	        }.bind(this), this.props.tag, this.props.page);
	    }});

	    Object.defineProperty(____Classa.prototype,"render",{writable:true,configurable:true,value:function() {"use strict";

	        var posts = [];
	        if (this.state && this.state.posts) {
	            this.state.posts.forEach(function (post) {
	                posts.push(React.createElement(PreviewItem, {author: "Nathan Hoffman", 
	                    title: post.title, 
	        ...
	        return (
	            React.createElement("div", null, 
	                React.createElement("h3", {className: "text-center"}, "Viewing: Recent Posts"), 
	                posts, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (function(){var ____Classf=React.Component;for(var ____Classf____Key in ____Classf){if(____Classf.hasOwnProperty(____Classf____Key)){____Classe[____Classf____Key]=____Classf[____Classf____Key];}}var ____SuperProtoOf____Classf=____Classf===null?null:____Classf.prototype;____Classe.prototype=Object.create(____SuperProtoOf____Classf);____Classe.prototype.constructor=____Classe;____Classe.__superConstructor__=____Classf;function ____Classe(){"use strict";if(____Classf!==null){____Classf.apply(this,arguments);}}
	    Object.defineProperty(____Classe.prototype,"render",{writable:true,configurable:true,value:function() {"use strict";
	        ...
	        return (
	            React.createElement("span", {style: st, className: "fa fa-" + this.props.icon + " fa-stack-1x"})
	        );
	    }});
	return ____Classe;})()
	    ...
	    Object.defineProperty(____Classi.prototype,"render",{writable:true,configurable:true,value:function() {"use strict";
	        return (
	            React.createElement("div", {className: "post-preview"}, 
	                React.createElement("a", {href: ("#post/" + this.props.id)}, 
	                    React.createElement("h2", {className: "post-title text-center"}, 
	                     this.props.title
	                    ), 
	                ...
	                React.createElement("p", {className: "post-meta text-right"}, "Posted by ", this.props.author, " on ", this.props.date)
	            )
	        );
	    }});
	return ____Classi;})();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fetch = __webpack_require__(179);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (function(){var ____Classd=React.Component;for(var ____Classd____Key in ____Classd){if(____Classd.hasOwnProperty(____Classd____Key)){____Classc[____Classd____Key]=____Classd[____Classd____Key];}}var ____SuperProtoOf____Classd=____Classd===null?null:____Classd.prototype;____Classc.prototype=Object.create(____SuperProtoOf____Classd);____Classc.prototype.constructor=____Classc;____Classc.__superConstructor__=____Classd;function ____Classc(){"use strict";if(____Classd!==null){____Classd.apply(this,arguments);}}

	    Object.defineProperty(____Classc.prototype,"componentDidMount",{writable:true,configurable:true,value:function() {"use strict";
	        data.getPost(this.props.id,function (post) {
	            this.setState(post);
	        }.bind(this));
	    }});

	    Object.defineProperty(____Classc.prototype,"render",{writable:true,configurable:true,value:function() {"use strict";

	        if(this.state && this.state.title)
	        {
	            return (
	                React.createElement("div", null, 
	                    React.createElement("h2", {className: "text-center"}, this.state.title), 
	                    this.state.body

	                )
	            );
	        }
	        else return (React.createElement("h2", null, "Loading..."))
	    }});
	return ____Classc;})();
